(function (global) {
  ...
  const messages = {
    en: {
      ...
      'guides.projects.step3': 'Configure Board columns: Backlog → Ready → In progress → In review → Done.',
    ...
    es: {
      ...
      'guides.projects.step3': 'Configurá columnas del Board: Backlog → Ready → In progress → In review → Done.',
