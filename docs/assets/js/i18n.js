(function (global) {
  ...
  const messages = {
    en: {
      ...
      'backlog.item.agile': 'Agile PM — Jira-like tool for user stories, tasks & sprints',
      'backlog.agile.desc': 'Pick and use an agile board (Jira, Trello, GitHub Projects, Azure Boards, etc.): epics, stories from Gherkin, tasks for QA work, sprint practice.',
      'backlog.accounts.agile': 'Jira or Trello free; or GitHub Projects; or Azure Boards (with DevOps)',
      'guides.accounts.agile': 'Agile PM — Jira free (atlassian.com) or Trello free (trello.com); or GitHub Projects; or Azure Boards with DevOps org.',
    ...
    es: {
      ...
      'backlog.item.agile': 'Gestión ágil — herramienta tipo Jira para user stories, tasks y sprints',
      'backlog.agile.desc': 'Elegir y usar un tablero ágil (Jira, Trello, GitHub Projects, Azure Boards, etc.): epics, stories desde Gherkin, tasks de QA, práctica de sprint.',
      'backlog.accounts.agile': 'Jira o Trello gratis; o GitHub Projects; o Azure Boards (con DevOps)',
      'guides.accounts.agile': 'Gestión ágil — Jira gratis (atlassian.com) o Trello gratis (trello.com); o GitHub Projects; o Azure Boards con org DevOps.',
